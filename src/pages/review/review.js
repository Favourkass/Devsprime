...
import { EntireWrapper, TitleParagraph, BackToCart, TitlePicture, TitleDiv } from './style'
...
function ReviewOrder ({getCardByCourseId,cartById,match}){  
    ...
    useEffect(()=>getCardByCourseId(token, cartId),[getCardByCourseId,cartId, token])

    return(
        <div>
        <NavBar/>
        <a href='/back'><BackToCart src='https://res.cloudinary.com/devsprime/image/upload/v1625432126/Icons%20and%20Logo/Back_to_Cart_zxh9nr.png'/></a>
        <EntireWrapper className="container">
            <TitleDiv>
